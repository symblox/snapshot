        ...
        <div>
            ...
            <div class="col-12 col-lg-4 float-left">
                ...
                >
                    ...
                    <UiButton @click="modalOpen = true" class="button--submit width-full mb-2">
                        {{ $t('page.addAction') }}
                    </UiButton>
                    <UiButton
                        @click="handleSubmit"
        ...
        async handleSubmit() {
            ...
            if (parseFloat(this.scores[0]) < parseFloat(this.params.proposalThreshold)) {
                this.$store.dispatch('notify', [
                    'red',
                    `proposer votes below proposal threshold, min is ${parseFloat(
                        this.params.proposalThreshold
                    ).toFixed(2)} SYX`
                ]);
                return;
            }
